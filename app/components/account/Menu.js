...
export default function Menu() {
  ...
  const logoutAccount = () => {
    Alert.alert(
      "Cerrar sesión",
      "Esta seguro que quieres salir de tu cuenta.",
    ...
    <>
      ...
      <List.Section>
        ...
        <List.Item
          ...
          description="Listado de todos los productos que te gustaron"
          left={(props) => <List.Icon {...props} icon="heart" />}
          onPress={() => navigation.navigate("favorites")}
        />
        <List.Item
          title="Cerrar sesión"
          description="Cierra la sesión y inicia con otra cuenta"
