...
import { SEARCH_HISTORY, API_URL } from "../utils/constansts";
import { size } from "lodash";
// Mis funciones de utils
import { sortArryByDate } from "../utils/functions";
export async function getSearchHistoryApi() {
  try {
    ...
    return sortArryByDate(JSON.parse(history));
  } catch (error) {
    console.log(error);
    return [];
  }
